...
if( isset($_POST["envoyer"])){
  ...
  $req="insert into demandez_devis(nom_prenom,ville,tel,email,type_local,message) 
  ...
  // Envoye dans l'email 
    try {
        ...
        $mail->Body = "Ce message vous à été envoyer via la page demande devis de le site <b>Clenix.fr</b> <br><br>
        <b>Nom :</b> $nom <br>
        <b>Ville :</b> $ville <br>
